...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2503&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-googleauthr-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-googleauthr` can be installed with `conda`:
...
```
mamba install r-googleauthr
```

It is possible to list all of the versions of `r-googleauthr` available on your platform with `conda`:
...
```
mamba search r-googleauthr --channel conda-forge
```
...
mamba repoquery search r-googleauthr --channel conda-forge

# List packages depending on `r-googleauthr`:
mamba repoquery whoneeds r-googleauthr --channel conda-forge

# List dependencies of `r-googleauthr`:
mamba repoquery depends r-googleauthr --channel conda-forge
```
